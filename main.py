...
message3 = tk.Label(window, text="Anika global solutionss Face Recognition Based Attendance System" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
